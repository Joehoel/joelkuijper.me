...
<ConsCard
  title="low code"
  cons={["Higher probability of needing to change services at scale", "Some low code tools require paid plans"]}
/>
...
<ConsCard
  title="Hasura"
  cons={[`You'll need lots of custom backend logic`, "You want authentication included zero-config"]}
/>
...
<ConsCard
  title="Prisma"
  cons={[`You want a solution that provides the API for you`, `You don't want to worry about self-hosting`]}
/>
