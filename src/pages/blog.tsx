            ...
            <section className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
                ...
                <div className="relative w-full mb-4">
                    <input
                        ...
                        className="px-4 py-2 focus:outline-none shadow-sm focus:shadow-md focus:scale-[1.01] transition-transform border border-gray-300 dark:border-gray-900 focus:ring-orange-500 focus:border-orange-500 block w-full rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                    />
                    <svg
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {!blogPosts.length && <p className="text-gray-600 dark:text-gray-400">No posts yet :(</p>}
                </div>
            </section>
        </Container>
    );
